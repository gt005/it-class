...
class Tasks(models.Model):
    ...
    result = models.CharField(null=True, verbose_name="Ответ на задачу", max_length=200)
    ...
    tries = models.IntegerField(default=0, verbose_name="Количество попыток ответа на каждого ученика (0 - бесконечно)")
